package com.example.sajilothree.AdapterPackages.BookingHistoryAdapter;
...
import com.example.sajilothree.ActivitiesPackage.BookingHistory.BookingHistoryDetails;
...
public class BookingHistoryAdapter extends RecyclerView.Adapter<BookingHistoryAdapter.MyViewHolder> {
    ...
    private ArrayList<com.example.sajilothree.ModelsPackage.BookingHistory.Result> finalBookings;

    public BookingHistoryAdapter(Context mContext, ArrayList<Result> finalBookings) {
    ...
    private void onParentCardClick(CardView parentCardView, int position) {
        parentCardView.setOnClickListener(v -> {
            try {
                if (BookingHistoryService.setBookingId(finalBookings.get(position).getBookingId())) {
                    mContext.startActivity(new Intent(mContext, BookingHistoryDetails.class));
